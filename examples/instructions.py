...
state = {
    "registers": {
        ...
        "P": {"bits": zeros(BITS), "bus": {"ADR": 0, "ALY": 0, "ALZ": 0}},
    },
    "alu": {
...
FETCH_INCREMENT_CTRLSEQ = {
    #         000 000 000 011 111 111 112 222
    ...
    "Z_ALZ": "___ __~ ", # if not GOTO: MOVE Z to P via ALZ
    "P_CLR": "___ _~_ ",
    "P_ALZ": "___ __~ ",
    ...
    # GOTO
    # 101d.sczn.x'''.''''
    "Z_ADR": "    _~~ ___ ___", # Z contains P+1
    "MEM_R": "    _~~ ___ ___",
    "M_CLR": "    _~_ ___ ___",
    "M_DAT": "    __~ ___ ___",

    "P_CLR": "    _~_ ___ ___", # MOVE Z to P via ADR
    "P_ADR": "    __~ ___ ___",
    ...
    "P_CLR": "    ___ _~_ ___", # optional (INC P)
    "P_ALZ": "    ___ __~ ___", # optional (INC P)

    "X_CLR": "    ___ _~_ ___", # optional (INC P)
    "X_ALZ": "    ___ __~ ___", # optional (INC P)

    "J_ADR": "    ___ ___ _~~", # optional (MOVE J to P)
    "P_CLR": "    ___ ___ _~_", # optional (MOVE J to P)
    "J_ADR": "    ___ ___ __~", # optional (MOVE J to P)
