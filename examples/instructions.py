...
FETCH_INCREMENT_CTRLSEQ = {
    ...
    "Z___ALZ": "___ __~ ", # if not GOTO: MOVE Z to P via ALZ
    "P___CLR": "___ _~_ ",
    "P___ALZ": "___ __~ ",
    ...
    # GOTO
    # 101d.sczn.x'''.''''
    "Z___ADR": "    _~~ ___ ", # Z contains P+1, load MEM into M
    "MEM___R": "    _~~ ___ ",
    "M___CLR": "    _~_ ___ ", # M or J
    "M___DAT": "    __~ ___ ", # M or J
    "ADR_ALY": "    _~~ ___ ",
    "ALU_INC": "    _~~ ___ ",
    "T___CLR": "    _~_ ___ ",
    "T___ALZ": "    __~ ___ ", # T contains P+2

    "T___DAT": "    ___ __~ ", # MOVE T (P+2) to X via DAT
    "X___CLR": "    ___ _~_ ", #
    "X___DAT": "    ___ __~ ", #

    "J___ADR": "    ___ __~ ", # MOVE J to P
    "P___CLR": "    ___ _~_ ", #
    "P___ADR": "    ___ __~ ", #
    #    ^
    # OR |
    #    V
    "T___ADR": "    ___ __~ ", # MOVE T (P+2) to P
    "P___CLR": "    ___ _~_ ", #
    "P___ADR": "    ___ __~ ", #
